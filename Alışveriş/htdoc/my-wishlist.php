...
<html lang="en">
	<head>
	    ...
	    <title>Benim dilek listem</title>
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>dilek listem</li>
			</ul>
...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			<thead>
				<tr>
					<th colspan="4">Benim dilek listem. </th>
				</tr>
			</thead>
			<tbody>
<?php
...
?>
				...
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">İstek listeniz boş</td>
