...
<html lang="en">
	<head>
	    ...
	    <title>Bekleyen Sipariş Geçmişi</title>
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-sub-total item">Birim fiyatı</th>
						<th class="cart-sub-total item">Kargo ücreti</th>
					<th class="cart-total">Genel Toplam</th>
					<th class="cart-total item">Ödeme şekli</th>
					<th class="cart-description item">Sipariş tarihi</th>
					<th class="cart-total last-item">Aksiyon</th>
				</tr>
			</thead><!-- /thead -->
...
<tr>
	<td colspan="9"><div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary"><a href="payment-method.php">Ödeme İşlemine Devam Edildi</a></button>
