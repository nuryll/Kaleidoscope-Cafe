...
{?>
									<div class="alert alert-error">
										<button type="button" class="close" data-dismiss="alert">×</button>
									<strong>Şimdi!</strong> 	<?php echo htmlentities($_SESSION['delmsg']);?><?php echo htmlentities($_SESSION['delmsg']="");?>
									</div>
<?php } ?>
...
<div class="control-group">
<label class="control-label" for="basicinput">İndirimden Sonra Ürün Fiyatı (Satış Fiyatı)</label>
<div class="controls">
...
<input type="file" name="productimage3"  class="span8 tip">
	...
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn">Ekle</button>
											</div>
										</div>
									</form>
							</div>
