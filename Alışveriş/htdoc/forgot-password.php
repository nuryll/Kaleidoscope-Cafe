...
<html lang="en">
	<head>
	    ...
	    <title>Alışveriş Portalı | Parolanızı mı unuttunuz</title>
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Parolanızı mı unuttunuz</li>
			</ul>
...
<div class="col-md-6 col-sm-6 sign-in">
	<h4 class="">Parolanızı mı unuttunuz</h4>
...
?>
		...
		<div class="form-group">
		    <label class="info-title" for="exampleInputEmail1">Mail Adres <span>*</span></label>
		    <input type="email" name="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" required >
		</div>
	  	<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">İletişim Numarası<span>*</span></label>
		 <input type="text" name="contact" class="form-control unicase-form-control text-input" id="contact" required>
		</div>
<div class="form-group">
	    	<label class="info-title" for="password">Parola <span>*</span></label>
...
<div class="form-group">
	  	...
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="change">Değişiklik</button>
	</form>					
</div>
<!-- Sign-in -->
